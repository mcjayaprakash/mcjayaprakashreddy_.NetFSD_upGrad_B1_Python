            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QuestionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuizId = table.Column<int>(type: "int", nullable: false),
                    QuestionText = table.Column<string>(type: "varchar(600)", maxLength: 600, nullable: false),
                    OptionA = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
                    OptionB = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
                    OptionC = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
                    OptionD = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
